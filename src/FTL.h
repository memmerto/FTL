...
enum query_type { TYPE_A = 1, TYPE_AAAA, TYPE_ANY, TYPE_SRV, TYPE_SOA, TYPE_PTR, TYPE_TXT, TYPE_NAPTR, TYPE_MAX } __attribute__ ((packed));
...
enum regex_type { REGEX_BLACKLIST, REGEX_WHITELIST, REGEX_CLI, REGEX_MAX } __attribute__ ((packed));
